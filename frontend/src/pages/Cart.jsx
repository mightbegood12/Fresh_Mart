  ...
  return (
    <>
      {cartItems.length === 0 ? (
        ...
        <div className="flex flex-col h-max  md:flex-row gap-1">
          ...
          <div className="flex flex-col w-2/4 p-2 my-4 ml-4 h-vh">
            ...
            <div className="flex flex-row gap-4">
              <button
                ...
                className="flex justify-center gap-2 items-center shadow-xl text-lg text-gray-600 bg-gray-50 backdrop-blur-md lg:font-semibold isolation-auto border-gray-50 before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full before:bg-orange-300 hover:text-gray-50 before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 relative z-10 px-4 py-2 overflow-hidden border-2 rounded-full group"
              >
                Checkout
                <svg
                  className="w-8 h-8 justify-end group-hover:rotate-90 group-hover:bg-gray-50 text-gray-50 ease-linear duration-300 rounded-full group-hover:border-none p-2 rotate-45"
                  viewBox="0 0 16 19"
